...
| ``auto_fan_cascade_regulated``           | Cascade regulation of the fan                              | -             | X                   | -            | -                       |
| ``auto_fan_mode_default_speed``          | Default fan speed to restore when auto-fan is deactivated   | -             | X                   | -            | -                       |
...
| ``should_device_be_active``                     | true if the underlying is active                                                                                                                                                                                |
...
| ``auto_fan_cascade_regulated``           | `true` if cascade regulation is configured                                                                                                                                                                      |
| ``auto_fan_default_speed``               | The default speed to restore when auto fan is deactivated (e.g. low, silent, 1)                                                                                                                                 |
| ``fan_accumulated_error``                | Accumulated error used in cascade speed regulation                                                                                                                                                              |
| ``is_cascade_active``                    | `true` if cascade fan regulation is currently active                                                                                                                                                            |
| ``is_saturated``                         | `true` if the main regulation algorithm is currently saturated                                                                                                                                                  |
| ``calculated_fan_mode``                  | The calculated target fan speed mode                                                                                                                                                                            |
